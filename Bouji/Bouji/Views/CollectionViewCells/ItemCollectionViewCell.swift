...
class ItemCollectionViewCell: UICollectionViewCell {
    ...
    private var topInset: Double = 2.5
    var name: String?
    var price: String?
    var image: UIImage?
...
extension  ItemCollectionViewCell {
    func setupTitleLabel(name: String, safeMargins: UILayoutGuide) {
        ...
        // add constraints
        titleLabel.topAnchor.constraint(equalTo: safeMargins.topAnchor, constant: topInset).isActive = true
        titleLabel.leadingAnchor.constraint(equalTo: safeMargins.leadingAnchor, constant: topInset).isActive = true
        titleLabel.trailingAnchor.constraint(equalTo: safeMargins.trailingAnchor, constant: -topInset).isActive = true
    ...
    func setupDescriptionLabel(itemDescription: String, safeMargins: UILayoutGuide) {
        ...
        // add constraints
        descriptionLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: topInset/2).isActive = true
        descriptionLabel.leadingAnchor.constraint(equalTo: safeMargins.leadingAnchor, constant: topInset).isActive = true
    ...
    func setupImageView(image: UIImage, safeMargins: UILayoutGuide) {
        ...
        // add constraints
        imageView.topAnchor.constraint(equalTo: descriptionLabel.bottomAnchor, constant: topInset).isActive = true
        imageView.leadingAnchor.constraint(equalTo: safeMargins.leadingAnchor, constant: topInset).isActive = true
        imageView.trailingAnchor.constraint(equalTo: safeMargins.trailingAnchor, constant: -topInset).isActive = true
        imageView.bottomAnchor.constraint(equalTo: safeMargins.bottomAnchor, constant: -topInset).isActive = true
    ...
    func setupPriceLabel(price: String, safeMargins: UILayoutGuide) {
        ...
        priceLabel.topAnchor.constraint(equalTo: safeMargins.topAnchor, constant: topInset).isActive = true
